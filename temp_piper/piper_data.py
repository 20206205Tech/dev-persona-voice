...
persona_nam_minh = DataPersona(
    ...
    avatar_url=f"{piper_env.R2_PUBLIC_DOMAIN}/images/vi-VN-NamMinhNeural-v1.png",
    greeting_text=generate_greeting_text("Nam Minh", "Nam"),
    greeting_audio_url=f"{piper_env.R2_PUBLIC_DOMAIN}/audio/vi-VN-NamMinhNeural.mp3",
    is_active=True,
)
...
persona_hoai_my = DataPersona(
    ...
    avatar_url=f"{piper_env.R2_PUBLIC_DOMAIN}/images/vi-VN-HoaiMyNeural-v1.png",
    greeting_text=generate_greeting_text("Hoài My", "Nữ"),
    greeting_audio_url=f"{piper_env.R2_PUBLIC_DOMAIN}/audio/vi-VN-HoaiMyNeural.mp3",
    is_active=True,
)
...
persona_quoc_hung = DataPersona(
    ...
    avatar_url=f"{piper_env.R2_PUBLIC_DOMAIN}/images/20.jpg",
    greeting_text=generate_greeting_text("Quốc Hùng", "Nam"),
    greeting_audio_url=f"{piper_env.R2_PUBLIC_DOMAIN}/audio/IKne3meq5aSn9XLyUdCD.mp3",
    is_active=True,
)
...
persona_duc_kien = DataPersona(
    ...
    avatar_url=f"{piper_env.R2_PUBLIC_DOMAIN}/images/2.jpg",
    greeting_text=generate_greeting_text("Đức Kiên", "Nam"),
    greeting_audio_url=f"{piper_env.R2_PUBLIC_DOMAIN}/audio/pNInz6obpgDQGcFmaJgB.mp3",
    is_active=True,
)
...
persona_lan_anh = DataPersona(
    ...
    avatar_url=f"{piper_env.R2_PUBLIC_DOMAIN}/images/47.jpg",
    greeting_text=generate_greeting_text("Lan Anh", "Nữ"),
    greeting_audio_url=f"{piper_env.R2_PUBLIC_DOMAIN}/audio/EXAVITQu4vr4xnSDxMaL.mp3",
    is_active=True,
)
...
persona_thanh_truc = DataPersona(
    ...
    avatar_url=f"{piper_env.R2_PUBLIC_DOMAIN}/images/15.jpg",
    greeting_text=generate_greeting_text("Thanh Trúc", "Nữ"),
    greeting_audio_url=f"{piper_env.R2_PUBLIC_DOMAIN}/audio/hpp4J3VqNfWAUOO0d1Us.mp3",
    is_active=True,
)
...
persona_ban_mai = DataPersona(
    ...
    avatar_url=f"{piper_env.R2_PUBLIC_DOMAIN}/images/26.jpg",
    greeting_text=generate_greeting_text("Ban Mai", "Nữ"),
    greeting_audio_url=f"{piper_env.R2_PUBLIC_DOMAIN}/audio/banmai.mp3",
    is_active=True,
)
...
persona_thanh_phuong = DataPersona(
    ...
    avatar_url=f"{piper_env.R2_PUBLIC_DOMAIN}/images/49.jpg",
    greeting_text=generate_greeting_text("Thanh Phương", "Nữ"),
    greeting_audio_url=f"{piper_env.R2_PUBLIC_DOMAIN}/audio/yannew.mp3",
    is_active=True,
)
...
persona_minh_quang = DataPersona(
    ...
    avatar_url=f"{piper_env.R2_PUBLIC_DOMAIN}/images/39.jpg",
    greeting_text=generate_greeting_text("Minh Quang", "Nam"),
    greeting_audio_url=f"{piper_env.R2_PUBLIC_DOMAIN}/audio/minhquang.mp3",
    is_active=True,
)
...
persona_manh_dung = DataPersona(
    ...
    avatar_url=f"{piper_env.R2_PUBLIC_DOMAIN}/images/29.jpg",
    greeting_text=generate_greeting_text("Mạnh Dũng", "Nam"),
    greeting_audio_url=f"{piper_env.R2_PUBLIC_DOMAIN}/audio/duyoryx3175.mp3",
    is_active=True,
)
