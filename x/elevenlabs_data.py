...
# --- KHỞI TẠO DỮ LIỆU BẰNG CLASSES VÀ THÊM VÀO LIST VỚI APPEND ---

SAMPLE_ENGINE_DATA = []
SAMPLE_VOICE_DATA = []
SAMPLE_PERSONA_DATA = []

# 1. Tạo và append các đối tượng DataEngine
...
voice_nam_minh = DataVoice(
    id=uuid.UUID("c12e3456-789a-bcde-f012-3456789abcde"),
...
voice_hoai_my = DataVoice(
    id=uuid.UUID("c12e3456-789a-bcde-f012-3456789abcd1"),
...
voice_quoc_hung = DataVoice(
    id=uuid.UUID("c12e3456-789a-bcde-f012-3456789abcd2"),
...
voice_duc_kien = DataVoice(
    id=uuid.UUID("c12e3456-789a-bcde-f012-3456789abcd3"),
...
voice_lan_anh = DataVoice(
    id=uuid.UUID("c12e3456-789a-bcde-f012-3456789abcd4"),
...
voice_thanh_truc = DataVoice(
    id=uuid.UUID("c12e3456-789a-bcde-f012-3456789abcd5"),
...
SAMPLE_VOICE_DATA.extend(
    [
        DataVoice(
            id=uuid.UUID("c12e3456-789a-bcde-f012-3456789abcd6"),
            voice_id="cjVigY5qzO86Huf0OWal",
            engine_id=engine_elevenlabs.id,
            is_active=True,
        ),
        DataVoice(
            id=uuid.UUID("c12e3456-789a-bcde-f012-3456789abcd7"),
            voice_id="CwhRBWXzGAHq8TQ4Fs17",
            engine_id=engine_elevenlabs.id,
            is_active=True,
        ),
        DataVoice(
            id=uuid.UUID("c12e3456-789a-bcde-f012-3456789abcd8"),
            voice_id="FGY2WhTYpPnrIDTdsKH5",
            engine_id=engine_elevenlabs.id,
            is_active=True,
        ),
        DataVoice(
            id=uuid.UUID("c12e3456-789a-bcde-f012-3456789abcd9"),
            voice_id="Xb7hH8MSUJpSbSDYk0k2",
            engine_id=engine_elevenlabs.id,
            is_active=True,
        ),
        DataVoice(
            id=uuid.UUID("c12e3456-789a-bcde-f012-3456789abcda"),
...
# 3. Tạo và append các đối tượng DataPersona (Sử dụng code của Engine và voice_id của Voice)
persona_nam_minh = DataPersona(
    id=uuid.UUID("f0e747a0-48ee-4d60-9302-197a8e225673"),
    name="Nam Minh",
    gender="Nam",
    tts_engine=engine_edge.code,
    voice_id=voice_nam_minh.voice_id,
...
persona_hoai_my = DataPersona(
    ...
    gender="Nữ",
    tts_engine=engine_edge.code,
    voice_id=voice_hoai_my.voice_id,
...
persona_quoc_hung = DataPersona(
    ...
    name="Quốc Hùng",
    gender="Nam",
    tts_engine=engine_elevenlabs.code,
    voice_id=voice_quoc_hung.voice_id,
...
persona_duc_kien = DataPersona(
    ...
    gender="Nam",
    tts_engine=engine_elevenlabs.code,
    voice_id=voice_duc_kien.voice_id,
...
persona_lan_anh = DataPersona(
    ...
    gender="Nữ",
    tts_engine=engine_elevenlabs.code,
    voice_id=voice_lan_anh.voice_id,
    description="Giọng nữ trưởng thành, đáng tin cậy và tự tin.",
    avatar_url=f"{elevenlabs_env.R2_PUBLIC_DOMAIN}/images/16.jpg",
...
persona_thanh_truc = DataPersona(
    ...
    gender="Nữ",
    tts_engine=engine_elevenlabs.code,
    voice_id=voice_thanh_truc.voice_id,
